...
local rodRemote = game:GetService("ReplicatedStorage").Packages._Index["sleitnick_net@0.2.0"].net["RF/ChargeFishingRod"]

local miniGameRemote = game:GetService("ReplicatedStorage").Packages._Index["sleitnick_net@0.2.0"].net["RF/RequestFishingMinigameStarted"]

local finishRemote = game:GetService("ReplicatedStorage").Packages._Index["sleitnick_net@0.2.0"].net["RE/FishingCompleted"]
    ...
    task.spawn(function()
        while autofish do
            pcall(function()
                ...
                -- รอซักพักให้เกมคิดว่ากำลังตกปลา
                task.wait(2.5)
